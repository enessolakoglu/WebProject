<%@ Page Language="C#" AutoEventWireup="true" CodeFile="vd.aspx.cs" Inherits="_Default" %>
        ...
        <div class="container">
            <div class="row">
               <div class="col-lg-4 col-sm-4">
                    <h1>Veri Depolama ve Sunucu Sistemleri Çözümleri</h1>
                </div>
                <div class="col-lg-8 col-sm-8">
                    <ol class="breadcrumb pull-right">
                        <li><a href="#">Anasayfa</a></li>
                        <li><a href="#">Bilisim Sistemleri Hizmetleri</a></li>
                        <li class="active" style="font-size: 15px">Veri Depolama ve Sunucu Sistemleri Çözümleri </li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div id="myCarousel" class="carousel slide">
              ...
              <div class="carousel-inner">
                <div class="active item">
                  <img src="img/resimler/veridepo1.jpg" alt="">
                  <div class="carousel-caption">
                    <p>
                  Veri Depolama ve Sunucu Sistemleri Çözümleri
                    </p>
                  </div>
                </div>
        ...
        <div class="col-lg-7 about wow fadeInRight">
         ...
         Veri Depolama ve Sunucu Sistemleri Çözümleri
          ...
          <p style="text-align:justify">
             Veri Depolama ve Sunucu Sistemlerinde, performans ve kapasite kullanımını en üst düzeye çıkaran birleşik işlevsellik sağlayarak, geniş bir yelpazede ihtiyaçları karşılayan global seviyede üreticilerle birlikte çözümler üretmekteyiz. Artan veriye dayalı olarak Veri Depolama Sistemleri ihtiyaçlarını karşılayacak giriş seviyesi, orta sınıf, ve high-end kurumsal uygulamalar, Büyük veri ve bulut depolama uygulamaları ile ihtiyaçlarınıza yönelik yeni bakış açıları ile sistemlerinizin performansını artırabiliriz.
 
             Bu esnek depolama ürünlerinden bazıları çok yönlülüğü maksimize etmek için SAN ve NAS özelliklerini birleştirirken, diğerleri birincil ve yedek depolamayı birleştirir. Katı-hal ve sabit disk sürücülerinin yakınsaması performansı dramatik olarak artırır.
 
             Kapsamlı kurumsal depolamadan tüm-flaş ve bulut depolama sistemleri arasında değişen çözümlerimizle sistemlerinizi inşa edebilir veya mevcut sistemlerinize entegre edebiliriz.
