<%@ Page Language="C#" AutoEventWireup="true" CodeFile="is.aspx.cs" Inherits="_Default" %>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4 col-sm-4">
                    <h1>İş Sürekliliği Ve Fkm Çözümleri</h1>
                </div>
                <div class="col-lg-8 col-sm-8">
                    <ol class="breadcrumb pull-right">
                        <li><a href="#">Anasayfa</a></li>
                        <li><a href="#">Bilisim Sistemleri Hizmetleri</a></li>
                        <li class="active">İş Sürekliliği ve FKM Çözümleri</li>
                    </ol>
                </div>
            </div>
        </div>
      ...
      <div class="row mar-b-50">
            ...
            <div id="myCarousel" class="carousel slide">
              ...
              <div class="carousel-inner">
                <div class="active item">
                  <img src="img/resimler/issurek1.jpg" alt="">
                  <div class="carousel-caption">
                    <p style="text-align:justify">
                  İş Sürekliliği ve FKM Çözümleri
                    </p>
                  </div>
                </div>
        ...
        <div class="col-lg-7 about wow fadeInRight">
         ...
         İş Sürekliliği ve FKM Çözümleri
          ...
          <p  style="text-align:justify">
            İş sürekliliği kavramı, bir şirketin veya kurum/kuruluşun herhangi bir problem, arıza, kesinti veya felaket durumunda, kritik iş yazılım ve donanımlarının, uygulamalarının, kesintisiz çalışmasını esas alan, sürekliliğinin sağlanmasına yönelik tanımıdır.
 
           İş sürekliliği için bir veri merkezi bulunmalı ve bu merkezden iş kritik uygulamaların çalışacağı ikinci bir veri merkezi çözümü tasarlanmalıdır.  İş sürekliliği Çözümleri oluşturulurken kurum içerisindeki süreçler dikkate alınmalı ve alınacak önlemler buna göre sıralanmalıdır. İş sürekliliği teknolojik donanımın yedeklenmesi olarak düşünülmemelidir, iş süreçlerinin devam etmesine engel olacak bir risk durumunda, çalışmaya devam edilmesini sağlayan bir çözüm olarak tasarlanmak zorundadır. Şirketin veya kurum/kuruluşun sistemlerinin ne kadar süreyle durması şirketin ne kadarlık mali kaybına, imaj kaybına neden olur gibi durumların her zaman düşünülüp analiz edilerek sistem tasarımları yapılmalıdır.
 
          SBT Savunma ve Bilişim Teknolojileri olarak iş sürekliliğine yönelik çözümler sunmaktayız.
