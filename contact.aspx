...
<body>
      ...
      <div class="row">
        <div class="col-lg-5 col-sm-5 address">
          <section class="contact-infos">
            ...
            <address>
              TEPE PRIME B BLOK KAT:16 NO:120,
              <br>
              ÇANKAYA/ANKARA
              <br>
        ...
        <div class="col-lg-7 col-sm-7 address">
            ...
            ILETISIME GECIN
             ...
             <label for="name">
              ...
              <asp:TextBox ID="AdSoyad" runat="server" class="form-control" Width="290px"></asp:TextBox>
            <span class="DipNot">*</span>
             <h3>Konu</h3>
                 <asp:TextBox ID="Konu" runat="server" class="form-control" Width="290px"></asp:TextBox>
               <span class="DipNot">*</span>
                <h3>E-posta</h3>
             <asp:TextBox ID="Eposta" runat="server" class="form-control" Width="290px"></asp:TextBox>
              <span class="DipNot">*</span>
             <h3>Tel</h3>
            <asp:TextBox ID="Tel" runat="server" class="form-control" Width="290px" 
                            MaxLength="11"></asp:TextBox>
            <span class="DipNot">*</span>
            <h3>Mesajınız</h3>
              <asp:TextBox ID="Mesajiniz" runat="server" class="form-control" Height="100px" 
        TextMode="MultiLine" Width="290px"></asp:TextBox>
            <span class="DipNot">*</span>
              <asp:Label ID="Sonuc" runat="server" Font-Bold="True" Font-Italic="True"></asp:Label><br />
              <asp:Button ID="Gonder" runat="server" Class="btn btn-info" 
        ValidationGroup="iletisim" onclick="Gonder_Click" Text="Gönder" />
                                &nbsp;<asp:Button ID="Temizle" runat="server" 
        Class="btn btn-info" EnableTheming="True" onclick="Temizle_Click" Text="Temizle" />
    ...
    <script>
        function initMap() {
            var uluru = { lat: 39.909690, lng: 32.755032 };
    ...
    <script async defer
    src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCRHzrH5V1AVFrnHbs838JfP4m31FWwiNk&callback=initMap">
    </script>
