            ...
            <div class="row">
                ...
                <div class="col-lg-8 col-sm-8">
                    <ol class="breadcrumb pull-right">
                        ...
                        <li class="active" style="font-size:10px">Sözleşme ve Proje Yönetim Danışmanlığı</li>
                    </ol>
                </div>
            </div>
        </div>
   ...
   <div class="container">
            ...
            <div id="myCarousel" class="carousel slide">
              ...
              <div class="carousel-inner">
                <div class="active item">
                  <img src="img/resimler/sistem1.jpg" alt="">
                  <div class="carousel-caption">
                    <p>
                   Sözleşme ve Proje Yönetim Danışmanlığı
                    </p>
                  </div>
                </div>
     ...
     Sözleşme ve Proje Yönetim Danışmanlığı
          ...
          <p style="text-align:justify">
              SBT Savunma ve Bilişim Teknolojileri bilgi birikimi, tecrübesi ve uzman kadrosuyla proje süreçlerini hızlandırabilir, büyük organizasyonlarınızı kolaylıkla planlayabilirsiniz.<br />

Verilen Hizmetlerin Kapsamı;<br />
             
              </p>
            <p style="text-align:justify">
Proje, Sözleşme  ve  Risk Yönetimi<br />
•    Uluslararası standartlara uygun Proje ve Sözleşme Yönetimi<br />
•    Proje , Risk ve  Sözleşme  Yönetimi<br />
           
                  </p>

            <p >
Organizasyon ve  Kurumsal Yapılanma <br />
•    Kamu kurumlarının ve özel kuruluşların modernizasyonu ve reorganizasyonu <br />
•    Eğitim sistemleri ve hizmetlerinin organizasyonu ve yönetimi<br />
•    Yönetim Bilgi Sistemlerinin Geliştirilmesi<br />
•    Kurumsal reorganizasyon ve geliştirilmesi<br />
•    Proje Yönetim ve Denetimi<br />
