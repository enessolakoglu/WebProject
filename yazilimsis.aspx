<%@ Page Language="C#" AutoEventWireup="true" CodeFile="fkm.aspx.cs" Inherits="fkm" %>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4 col-sm-4">
                    <h1>Yazılım ve Sistem Test Yönetim Danışmanlığı</h1>
                </div>
                <div class="col-lg-8 col-sm-8">
                    <ol class="breadcrumb pull-right">
                        <li><a href="#">Anasayfa</a></li>
                        <li><a href="#">Bilişim Danışmanlığı Hizmetleri</a></li>
                        <li class="active" style="font-size: 10px">Yazılım ve Sistem Test Yönetim Danışmanlığı</li>
                    </ol>
                </div>
            </div>
        </div>
   ...
   <div class="container">
            ...
            <div id="myCarousel" class="carousel slide">
              ...
              <div class="carousel-inner">
                <div class="active item">
                  <img src="img/resimler/yazilimsis.jpg" alt="">
                  <div class="carousel-caption">
                    <p>
                   Yazılım ve Sistem Test Yönetim Danışmanlığı
                    </p>
                  </div>
                </div>
     ...
     Yazılım ve Sistem Test Yönetim Danışmanlığı
          ...
          <p style="text-align:justify">
            SBT Savunma ve Bilişim Teknolojileri, Entegre Test Yönetimi Yaklaşımı, Bağımsız Test ve Dış kaynak Hizmetleri ile müşterilerinin yazılım ve bilişim alanındaki ürün ve hizmetlerinin kalitesini arttırmak için alternatif çözümler sunmaktadır.<br />

Yazılım Test Hizmetleri kapsamında Yazılım Geliştirme Yaşam Döngüsü içinde her aşamayı doğrulama ve test bakış açısı ile destekleyecek hizmetler sunmaktayız. Test yönetimi kapsamında gerek Hizmet Seviyesi Anlaşmalar (SLA) ile baştan sona test stratejinizi oluşturup, test planlama, test tasarımı, test senaryoları, test ortamı, testlerin koşturulması dahil test süreci ile ilgili tüm sorumluluğu üstlenmekte, gerekse alanında tecrübeli personelimizi dış kaynak olarak projelerde görevlendirerek mevcut test ekiplerinizi desteklemekteyiz.<br />
              <br />
•	Bağımsız Test<br />
•	Geliştirme Kalite Güvence<br />
•	Test Yönetimi<br />
•	Dış Kaynak<br />
•	Yönetilen Hizmetler<br />
•	Test Teknolojileri Destek<br />
•	Test Verisi<br />
•	Test Otomasyonu<br />
•	Test Ortamı Yönetimi<br />
•	Uygulama Geliştirme Yaşam Döngüsü Yönetimi<br />
•	İşlevsel Testler<br />
•	İşlevsel olmayan testler<br />
•	Performans ve Yük Testleri<br />
