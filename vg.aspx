<%@ Page Language="C#" AutoEventWireup="true" CodeFile="vg.aspx.cs" Inherits="_Default" %>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4 col-sm-4">
                    <h1>Veri Güvenliği Çözümleri</h1>
                </div>
                <div class="col-lg-8 col-sm-8">
                    <ol class="breadcrumb pull-right">
                        <li><a href="#">Anasayfa</a></li>
                        <li><a href="#">Bilisim Sistemleri Hizmetleri</a></li>
                        <li class="active">Veri Güvenliği Çözümleri</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div id="myCarousel" class="carousel slide">
              ...
              <div class="carousel-inner">
                <div class="active item">
                  <img src="img/resimler/veriguven1.jpg" alt="">
        ...
        <div class="col-lg-7 about wow fadeInRight">
         ...
         Veri Güvenliği Çözümleri
          ...
          <p style="text-align:justify">
              Enterprise kuruluşların fiziksel güvenliği yanında dahili organizasyonunda yapılacak iş ve işlemlere karşı oluşan siber güvenlik tehditlerini engelleme faliyetleri de önemli bir çalışma alanıdır. Özellikle günümüzde mobil iletişim ve bilişim sistemlerindeki gelişmeler, bu yazılımların ve donanımlarının kabiliyetlerinin artması tehditi azımsanmayacak şekilde tehlikeli hale getirmiştir.  Örnek olması açısından; bir kuruluşta, büyük IT altyapısı, kamera,  otomatik güvenli giriş sistemi, kablosusuz internet erişim noktası, analog ya da sayısal telefon bulunup havalimanları operasyonlarının yönetilmesi gibi kritik işler bile büyük bir bilgisayar ağı altyapısı üzerindedir. Tüm bu sistemler siber tehditler için saldırı noktalarıdır. Böylesine büyük sistemlerin korunmasında uzman ekibimiz ile uygun çözümler sunmaktayız.
