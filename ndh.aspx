        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4 col-sm-4">
                    <h1>Network Danışmanlığı Hizmetleri</h1>
                </div>
                <div class="col-lg-8 col-sm-8">
                    <ol class="breadcrumb pull-right">
                        <li><a href="#">Anasayfa</a></li>
                        <li><a href="#">Bilişim Danışmanlığı Hizmetleri</a></li>
                        <li class="active" >Network Danışmanlığı Hizmetleri</li>
                    </ol>
                </div>
            </div>
        </div>
		  ...
		  <div class="row mar-b-50">
				...
				<div id="myCarousel" class="carousel slide">
				  ...
				  <div class="carousel-inner">
					<div class="active item">
					  <img src="img/resimler/netdanis.jpg" alt="">
			...
			<div class="col-lg-7 about wow fadeInRight">
			  ...
			  <p  style="text-align:justify">
				SBT Savunma ve Bilişim Teknolojileri, kurulduğu günden bu yana öncelikli olarak bilgisayar ağları konusunda hep üst düzey ve katma değer içeren hizmetleri optimum şekilde sunmayı amaçlamıştır. 
                  Gerek bu konularda alınan sayısız eğitim ve sertifikalar, gerekse elde edilmiş çok değerli bilgi birikimi ve tecrübe ile size bilgisayar ağları konusunda ideal bir danışman hizmeti sunmayı amaçlamaktadır.<br /><br />

Network danışmanlık hizmeti kapsamı;<br />

•	Switch ve VLAN (Virtual Local Area Network) hizmetleri ve implementasyonu<br />
•	Router hizmetleri ve implementasyonu<br />
•	VoIP cihazları hizmetleri ve implementasyonu<br />
•	Fiber, UTP kablolama ve iyileştirme hizmetleri<br />
•	Indoor ve/veya outdoor Wireless (Kablosuz Ağlar) Networking hizmetleri ve implementasyonu<br />
•	VPN hizmetleri
			  </p>
			</div>
		  </div>
