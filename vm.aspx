<%@ Page Language="C#" AutoEventWireup="true" CodeFile="vm.aspx.cs" Inherits="_Default" %>
               ...
               <div class="col-lg-4 col-sm-4">
                ...
                <div class="col-lg-8 col-sm-8">
                    <ol class="breadcrumb pull-right">
                        ...
                        <li class="active">Veri Merkezi Çözümleri</li>
                    </ol>
                </div>
            </div>
        </div>
      ...
      <div class="row mar-b-50">
        ...
        <div class="col-lg-7 about wow fadeInRight">
          ...
          <p style="text-align:justify">
             Dünya üzerindeki verinin artış hızının oldukça yüksek olduğu bir teknolojik dönüşüm içerisindeyiz. Daha da katlanarak büyüyen bir veri var dünya üzerinde. Buda verilerin bir merkezde toplanası güvenliğinden maliyetlerine kadar bir çok noktadan ortak kaynaklar kullanımına zorlamaktadır.  Veri merkezi olarak adlandırılan yapı orta ve büyük çaplı şirketlerin kullanmış oldukları ve tüm sunucu, veri depolama sistemleri, ağ ve güvenlik sistemleri gibi cihazlarını barındırdıkları ortamdır. Böyle bir sisteme geçişin zorunluluğu olarak, komplex yapıların düzenli bir şekle dönüştürülmesi, maliyeti düşürmek ve cihaz takibinin tek bir yerden yapılması gibi sebepler olarak sıralayabiliriz.
