<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ag.aspx.cs" Inherits="_Default" %>
        ...
        <div class="container">
            <div class="row">
               <div class="col-lg-4 col-sm-4">
                    <h1>Ağ Cihazları Çözümleri</h1>
                </div>
                <div class="col-lg-8 col-sm-8">
                    <ol class="breadcrumb pull-right">
                        <li><a href="#">Anasayfa</a></li>
                        <li><a href="#">Bilisim Sistemleri Hizmetleri</a></li>
                        <li class="active">Ağ Cihazları Çözümleri</li>
                    </ol>
                </div>
            </div>
        </div>
      ...
      <div class="row mar-b-50">
            ...
            <div id="myCarousel" class="carousel slide">
              ...
              <div class="carousel-inner">
                <div class="active item">
                    <p> &nbsp; </p>
                  <img src="img/resimler/agcihaz1.jpg" alt="">
                  <div class="carousel-caption">
                    <p>
                    Ağ Cihazları Çözümleri
                    </p>
                  </div>
                </div>
        ...
        <div class="col-lg-7 about wow fadeInRight">
          ...
          <p  style="text-align:justify">
             Ağ cihazları alanında Network Altyapısının tasarlanması, altyapı topolojisine göre en uygun dünya standartlarında ürünlerin konumlandırılarak network altyapısının oluşturulması, güvenlik analizi, güvenlik cihazlarının kurulumu, uzak lokasyonlar arasında network bağlantılarının kurulması, yedekli network altyapılarının oluşturulması gibi çözümleri hizmetinize sunmaktayız.
