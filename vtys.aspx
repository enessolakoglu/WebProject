<%@ Page Language="C#" AutoEventWireup="true" CodeFile="vtys.aspx.cs" Inherits="_Default" %>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4 col-sm-4">
                    <h1>VERİ TABANI YÖNETİM SİSTEMLERİ DANISMANLIK HİZMETİ</h1>
                </div>
                <div class="col-lg-8 col-sm-8">
                    <ol class="breadcrumb pull-right">
                        <li><a href="#">Anasayfa</a></li>
                        <li><a href="#">Bilişim Danışmanlığı Hizmetleri</a></li>
                        <li class="active" style="font-size: 10px">Veri Tabanı Yönetim Sistemleri Danışmanlık Hizmeti</li>
                    </ol>
                </div>
            </div>
        </div>
      ...
      <div class="row mar-b-50">
            ...
            <div id="myCarousel" class="carousel slide">
              ...
              <div class="carousel-inner">
                <div class="active item">
                  <img src="img/resimler/veritaban1.jpg" alt="">
                  <div class="carousel-caption">
                    <p>
                    Veri Tabanı Yönetim Sistemleri Danışmanlık Hizmeti
                    </p>
                  </div>
                </div>
        ...
        <div class="col-lg-7 about wow fadeInRight">
          ...
          <p style="text-align:justify">
           Database sistemleri için verdiğimiz teknik destek ve danışmanlık hizmetleri;<br />
              <br />
•	Yedekleme ve veri kurtarma;<br />
•	Periyodik bakım hizmetleri,<br />
•	Farklı uygulamalarınızın veritabanları arasında veri aktarımı,<br />
•	Veritabanı teknik destek ve yönetim hizmetleri<br />
•	Kurulum ve sürüm yükseltme<br />
•	Konfigürasyon yönetimi<br />
•	Performans izleme ve iyileştirme<br />
